...
If you want to upgrade to a JDBC based persistence store, please follow the steps outlined in link:persistent_timer.adoc[BPM Suite Persistent Timer Setup].
...
. Replace the contents of the filewith the following entries - replace `user@domain.org` with suitable email addresses:
+
----
...
user30=user@domain.org:en-UK:user31
